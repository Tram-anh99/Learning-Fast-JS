    ...
    try:
        ...
        if vung_trong_count == 0:
            ...
            toa_do_list = [
                ...
                ToaDoVung(vung_trong_id=vung_trong_list[0].id, thu_tu=1, vi_do=10.5234, kinh_do=106.4567),
                ToaDoVung(vung_trong_id=vung_trong_list[0].id, thu_tu=2, vi_do=10.5245, kinh_do=106.4589),
                ToaDoVung(vung_trong_id=vung_trong_list[0].id, thu_tu=3, vi_do=10.5221, kinh_do=106.4601),
                ToaDoVung(vung_trong_id=vung_trong_list[0].id, thu_tu=4, vi_do=10.5210, kinh_do=106.4579),
                
                # Vùng 2: Polygon ở Đắk Lắk
                ToaDoVung(vung_trong_id=vung_trong_list[1].id, thu_tu=1, vi_do=12.6667, kinh_do=108.0500),
                ToaDoVung(vung_trong_id=vung_trong_list[1].id, thu_tu=2, vi_do=12.6689, kinh_do=108.0534),
                ToaDoVung(vung_trong_id=vung_trong_list[1].id, thu_tu=3, vi_do=12.6656, kinh_do=108.0567),
                ToaDoVung(vung_trong_id=vung_trong_list[1].id, thu_tu=4, vi_do=12.6634, kinh_do=108.0523),
                
                # Vùng 3: Polygon ở Gia Lai
                ToaDoVung(vung_trong_id=vung_trong_list[2].id, thu_tu=1, vi_do=13.9787, kinh_do=108.0045),
                ToaDoVung(vung_trong_id=vung_trong_list[2].id, thu_tu=2, vi_do=13.9801, kinh_do=108.0078),
                ToaDoVung(vung_trong_id=vung_trong_list[2].id, thu_tu=3, vi_do=13.9776, kinh_do=108.0089),
                ToaDoVung(vung_trong_id=vung_trong_list[2].id, thu_tu=4, vi_do=13.9765, kinh_do=108.0056),
            ]
