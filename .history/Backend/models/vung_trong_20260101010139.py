...
class VungTrong(Base):
    ...
    # - Diện tích tính bằng hecta (ha) - NOTE: Column name là dien_tich trong DB
    # Example: 5.5, 10.25
    
    # ========== FOREIGN KEYS ==========
    chu_so_huu_id = Column(Integer, ForeignKey("nongsan.chu_vung.id"))
    # - ForeignKey: Liên kết đến bảng chu_vung (chủ vùng)
    # - Format: "schema.table.column"
    # - nullable=True (default): Vùng có thể chưa có chủ
    # - NOTE: DB column name là chu_so_huu_id
    ...
    # - NOTE: DB column name là ngay_tao (not created_at)
