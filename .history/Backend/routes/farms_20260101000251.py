...
from models.chu_vung import ChuVung
from models.trang_thai import TrangThai
from schemas import (
...
async def get_all_farms(
    ...
    for farm in farms:
        farm_dict = {
            ...
            "dien_tich_ha": farm.dien_tich_ha,
...
async def create_farm(farm_data: VungTrongCreate, db: Session = Depends(get_db)):
    ...
    new_farm = VungTrong(
        ...
        dien_tich_ha=farm_data.dien_tich_ha,
...
async def update_farm(farm_id: int, farm_data: VungTrongCreate, db: Session = Depends(get_db)):
    ...
    farm.dien_tich_ha = farm_data.dien_tich_ha
