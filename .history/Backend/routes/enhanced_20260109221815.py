...
async def get_facilities_enhanced(
    ...
    has_coordinates: Optional[bool] = Query(None, description="Filter facilities with coordinates"),
    loai_hinh_id: Optional[int] = Query(None, description="Filter by facility type"),
...
async def get_facilities_for_map(
    tinh_id: Optional[int] = Query(None, description="Filter by province ID"),
    bounds: Optional[str] = Query(None, description="Bounding box: lat_min,lon_min,lat_max,lon_max")
):
    """
