...
- [x] Sidebar hiển thị đúng trên mobile 6 inch
- [x] Navigation bar có icon và label rõ ràng
- [x] Charts đọc được trên màn hình nhỏ
- [x] Bảng dữ liệu scroll được ngang
- [x] Forms dễ sử dụng trên touch screen
- [x] Không có overflow hoặc element bị che khuất
