...
<template>
  <div class="webgis-container">
    ...
    <div class="absolute z-20 p-3 bg-white rounded-lg shadow-lg bottom-6 right-6">
      ...
      <div class="space-y-2">
        ...
        <label class="flex items-center gap-2 cursor-pointer hover:bg-gray-50 p-2 rounded">
          <input 
            type="radio" 
            :value="'hoangSaTruongSa'" 
            v-model="selectedLayer"
            @change="switchLayer('hoangSaTruongSa')"
            class="w-4 h-4"
          >
          <span class="text-sm">Hoàng Sa & Trường Sa</span>
        </label>
      </div>
    </div>
