...
<template>
  <div class="webgis-container">
    ...
    <!-- Layer Selector Control - Hover to show -->
    <div class="absolute z-20 top-6 right-6 group">
      <!-- Button -->
      <button class="p-2.5 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div class="absolute hidden group-hover:block top-12 right-0 bg-white rounded-lg shadow-lg p-3 w-48">
