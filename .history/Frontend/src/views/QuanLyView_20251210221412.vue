...
<template>
      <div class="admin-container">
            ...
            <div class="relative flex-1 w-full h-screen overflow-hidden"> 
  
  <div id="map" class="absolute inset-0 z-0 bg-gray-200">
     <h1 class="mt-20 text-center">Đang tải bản đồ...</h1> </div>
