...
.sidebar {
  width: 320px;
  background-color: var(--grey-sidebar); /* Nền trắng */
...
.list-container { padding: 15px; overflow-y: auto; background-color: #f8fafc; flex-grow: 1; }
...
.list-item.active {
  background-color: var(--primary-dark); /* Nền xanh thẫm */
  color: white;
  border-color: var(--primary-dark);
  border-left-color: #74c69d; /* Viền trái màu xanh sáng nổi bật */
}

/* Sửa lại text bên trong item cho đẹp */
.list-item strong { display: block; font-size: 0.95rem; margin-bottom: 3px; }
