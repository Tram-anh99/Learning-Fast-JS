...
<template>
      ...
      <div class="h-screen flex flex-col w-full gap-5 p-5 overflow-y-auto bg-slate-100 scrollbar-custom">
    ...
    -->
            ...
            <div class="flex gap-5 min-h-[400px]">
                  ...
                  <div class="flex-1 min-w-[300px] bg-white border border-white shadow-md rounded-xl p-4">
      ...
      -->
            ...
            <!-- Chiều cao tự động theo nội dung -->
            <div class="bg-white border border-white shadow-md rounded-xl p-4 min-h-[350px]">
