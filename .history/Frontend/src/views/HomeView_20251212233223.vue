  ...
  <div class="webgis-container">
    ...
    <aside class="floating-sidebar">
      ...
      <div v-if="!vungDangXem" class="flex flex-col flex-grow overflow-hidden">
        ...
        <div class="flex flex-shrink-0 gap-2 p-3 overflow-x-auto overflow-y-hidden border-b border-slate-200/50 bg-gradient-to-r from-slate-50 to-blue-50 no-scrollbar">
          <!-- Tab All -->
          <button 
