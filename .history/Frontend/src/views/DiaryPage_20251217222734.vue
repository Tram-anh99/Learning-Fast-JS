 ...
 */
const fields = ref([
  // Sync với mockDataVung từ statusHelpers
  { id: 'field-001', ma: 'VT-001', name: 'HTX Xoài Mỹ Xương', area: 5, crop: 'Xoài', status: 'Đang canh tác' },
  { id: 'field-002', ma: 'VT-002', name: 'Thanh Long VietGAP', area: 3.2, crop: 'Thanh long', status: 'Cảnh báo dịch hại' },
  { id: 'field-003', ma: 'VT-003', name: 'Lúa Organic Đồng Tháp', area: 10, crop: 'Lúa', status: 'Đang thu hoạch' },
  { id: 'field-004', ma: 'VT-004', name: 'Rau An Toàn Lâm Đồng', area: 2.5, crop: 'Rau', status: 'Đang canh tác' },
  { id: 'field-005', ma: 'VT-005', name: 'Dừa Bến Tre', area: 8, crop: 'Dừa', status: 'Đã thu hoạch' }
]);
...
<template>
  <div class="font-sans antialiased h-screen flex flex-col" style="background-color: #fbfced;">
    <!-- Main Content -->
    <main class="flex-1 w-full px-3 sm:px-4 py-4 sm:py-6 pb-[85px] mx-auto md:px-6 lg:px-8 max-w-7xl overflow-y-auto scrollbar-custom">
      <!-- Header Section -->
      <div class="flex flex-col justify-between gap-3 sm:gap-4 mb-6 sm:mb-8 md:flex-row md:items-center">
        <div>
          <h2 class="text-2xl sm:text-3xl font-black mb-1" style="color: #24504b;">Hôm nay bác làm gì?</h2>
          <p class="text-base sm:text-lg" style="color: rgba(36, 80, 75, 0.7);">Ghi lại hoạt động canh tác nhanh chóng và dễ dàng.
          </p>
        </div>
      ...
      <section class="mb-6 sm:mb-8 bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6">
        <h3 class="flex items-center gap-2 mb-3 sm:mb-4 text-base sm:text-lg font-bold" style="color: #24504b;">
          <span class="material-symbols-outlined text-xl sm:text-2xl" style="color: #24504b;">agriculture</span>
