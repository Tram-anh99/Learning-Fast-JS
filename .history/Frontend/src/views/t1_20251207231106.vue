            ...
            <aside class="floating-sidebar">
                  ...
                  <div class="sidebar-header" :class="{ 'detail-mode': vungDangXem }">
                        ...
                        <div v-else class="header-content detail">
                              <button @click="quayLaiDanhSach" class="btn-back"><i
                  ...
                  <div v-if="!vungDangXem" class="list-view">
                        <div class="sidebar-tabs">
                              <button class="tab-btn" :class="{ active: boLocHienTai === 'all' }"
                                    @click="boLocHienTai = 'all'">Tất
                                    cả</button>
                        ...
                        <div class="sidebar-content">
                              <ul class="layer-list">
                                    <li v-for="vung in danhSachHienThi" :key="vung.id" class="layer-item"
                                          @click="chonVung(vung)">
                                          <div class="item-thumb" :style="{ backgroundImage: `url(${vung.anh})` }">
                                          </div>
                                          <div class="item-info">
                                                <span class="item-name">{{ vung.ten }}</span>
                                                <span class="item-sub"> <i class="fas fa-certificate"></i> {{
                                                      vung.chungNhan }}</span>
                                          </div>
                  ...
                  <div v-else class="detail-view">
                        <div class="detail-cover" :style="{ backgroundImage: `url(${vungDangXem.anh})` }">
                              <div class="overlay">
                                    ...
                                    <span class="cert-badge"><i class="fas fa-check-circle"></i> {{
                                          vungDangXem.chungNhan }}</span>
                              </div>
                        </div>
                        ...
                        <div class="detail-content">
                              ...
                              <div class="timeline-section">
                                    ...
                                    <div class="timeline">
                                          <div v-for="(log, idx) in vungDangXem.nhatKy" :key="idx"
                                                class="timeline-item">
