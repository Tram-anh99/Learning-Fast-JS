...
.sidebar {
  ...
  backdrop-filter: blur(20px); /* Blur mạnh để làm mờ bản đồ phía dưới nếu bị che */
  -webkit-backdrop-filter: blur(20px);
  border-right: 1px solid rgba(255, 255, 255, 0.6);
  
  display: flex; flex-direction: column; z-index: 1000;
  box-shadow: 10px 0 30px rgba(0,0,0,0.05); /* Bóng đổ mềm */
}

.header-box {
  background: rgba(16, 185, 129, 0.1); /* Đầu đề hơi xanh nhẹ */
  padding: 25px 20px;
  border-bottom: 1px solid rgba(255,255,255,0.5);
}

.header-box h2 {
  margin: 0; font-size: 1.4rem; color: #065f46; text-shadow: 0 1px 0 rgba(255,255,255,0.8);
}

.list-container { padding: 20px; overflow-y: auto; }
...
.list-item:hover {
  ...
  box-shadow: 0 10px 20px rgba(5, 150, 105, 0.1); /* Bóng xanh khi hover */
}
...
.list-item.active {
  ...
  color: white;
  border: none;
  box-shadow: 0 10px 25px rgba(16, 185, 129, 0.4); /* Glow effect */
}
