...
<template>
  <div class="font-sans antialiased min-h-screen flex flex-col bg-[#FAFAF5] pb-20">
    <!-- Main Content -->
    <main class="flex-grow py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full overflow-y-auto">
