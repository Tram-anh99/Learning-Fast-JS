    ...
    <header class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-[#D7CCC8]/30 shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
          ...
          <!-- Navigation -->
          <nav class="hidden md:flex items-center space-x-1 bg-[#E8F5E9]/50 p-1.5 rounded-full">
            <a class="px-4 py-2 text-sm font-medium text-[#5D4037] hover:text-[#2E7D32] rounded-full transition-colors" href="#">Tổng quan</a>
            <a class="px-4 py-2 text-sm font-bold text-[#2E7D32] bg-white shadow-sm rounded-full" href="#">Nhật ký</a>
            <a class="px-4 py-2 text-sm font-medium text-[#5D4037] hover:text-[#2E7D32] rounded-full transition-colors" href="#">Vùng trồng</a>
          </nav>
