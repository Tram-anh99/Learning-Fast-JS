...
.floating-sidebar {
  ...
  z-index: 1000; /* Nằm đè lên trên bản đồ (z-index cao hơn map) */
}

/* ... Các class con của Sidebar giữ nguyên ... *//* QUAN TRỌNG: SỬA ĐOẠN CSS NÀY */
.webgis-container {
  position: absolute;
  /* Ép nó bung ra khỏi dòng chảy layout */
  top: 0;
  left: 0;
  width: 100%;
  height: 100%;
  /* Chiếm trọn khung cha (content-area) */
  display: flex;
}
...
.map-container {
  ...
  /* Màu xám đệm nếu map chưa tải kịp */
}
