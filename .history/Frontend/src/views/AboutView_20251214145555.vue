...
// ========== STATE ==========
// (Không có state cho trang này)

// ========== DATA ==========
// (Không có dữ liệu động cho trang này)

// ========== METHODS ==========
// (Không có methods cần thiết cho trang này)
</script>
...
@media (min-width: 1024px) {
  ...
  .about {
    min-height: 100vh; /* Chiều cao tối thiểu = viewport height */
    display: flex; /* Flex container để center content */
