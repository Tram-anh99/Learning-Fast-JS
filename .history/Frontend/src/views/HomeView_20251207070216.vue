...
<style scoped>
.webgis-container { position: relative; height: 100%; width: 100%; }
.map-container { height: 100%; width: 100%; z-index: 0; }

.floating-sidebar {
  position: absolute;
  top: 10px; left: 10px; bottom: 10px; /* Cập nhật vị trí sát lề */
  width: 340px;
...
.tool-btn {
  ...
  box-shadow: 0 2px 5px rgba(0,0,0,0.15); cursor: pointer; color: #444; font-size: 1rem;
}
.tool-btn:hover { background: #1b4332; color: white; }
.divider { height: 1px; background: rgba(0,0,0,0.1); margin: 2px 0; }
</style>