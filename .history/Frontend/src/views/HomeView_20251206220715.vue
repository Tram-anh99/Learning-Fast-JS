...
.webgis-layout {
  ...
  width: 100%;
  position: relative;
  background: #e2e8f0; /* Nền xám đệm dưới bản đồ */
}
...
.sidebar {
  ...
  z-index: 1000;
  box-shadow: 4px 0 24px rgba(0,0,0,0.08); /* Bóng đổ sang phải mượt mà */
}

.header-box {
  background: transparent; /* Bỏ nền xanh cũ */
  color: var(--text-main);
...
.header-box h2 {
  margin: 0; font-size: 1.25rem; font-weight: 700; color: var(--primary-color);
}
...
.list-item strong { display: block; font-size: 0.9rem; margin-bottom: 2px; }
