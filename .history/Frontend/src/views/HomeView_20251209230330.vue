    ...
    <aside class="floating-sidebar">
      ...
      <div v-else class="detail-view">
        ...
        <div class="detail-content">
          ...
          <button 
  @click="handleSearch" 
  class="bg-green-600 hover:bg-green-700 text-white px-6 rounded-lg font-bold flex items-center justify-center min-w-[80px]"
>
  <div v-if="!isSearching" class="flex items-center">
      <svg style="width: 20px; height: 20px;" class="mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
      </svg>
      <span>Tìm</span>
  </div>

  <svg v-else class="text-white animate-spin" style="width: 20px; height: 20px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
