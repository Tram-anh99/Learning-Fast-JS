...
.sidebar {
  ...
  bottom: 20px;       /* Cách lề dưới (để tạo khoảng hở đẹp) */
  width: 340px;
  
  /* HIỆU ỨNG KÍNH MỜ (Đã chỉnh lại độ trong suốt để thấy map bên dưới) */
  background: rgba(255, 255, 255, 0.7); /* Trắng trong suốt 70% */
  backdrop-filter: blur(15px);          /* Làm mờ bản đồ bên dưới */
  -webkit-backdrop-filter: blur(15px);
  
  border-radius: 16px; /* Bo tròn các góc */
  box-shadow: 0 8px 32px rgba(0, 0, 0, 0.2); /* Bóng đổ sâu */
  border: 1px solid rgba(255, 255, 255, 0.4); /* Viền kính sáng */
  
  display: flex; flex-direction: column;
  z-index: 1000; /* Nằm đè lên trên bản đồ */
}
...
.header-box h2 {
  ...
  color: var(--primary-dark); /* Dùng màu xanh đậm đã khai báo */
