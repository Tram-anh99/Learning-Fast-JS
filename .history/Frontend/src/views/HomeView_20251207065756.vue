...
<div class="sidebar-content">
  <ul class="layer-list">
    ...
    Và đừng quên thêm hàm `zoomToVung` vào phần `<script setup>` ở trên đầu file:
...
// HÀM MỚI: Xử lý Zoom khi click
const zoomToVung = (vung) => {
  if (map.value && vung.toaDo) {
          // Bay tới tọa độ vùng trồng với độ zoom 16
          map.value.flyTo(vung.toaDo, 16, {
