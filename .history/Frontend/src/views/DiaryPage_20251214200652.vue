...
<template>
  <div class="font-sans antialiased flex flex-col bg-[#FAFAF5] overflow-y-auto scrollbar-custom w-full">
    <!-- Main Content -->
    <main class="w-full px-4 py-6 pb-16 mx-auto sm:px-6 lg:px-8 max-w-7xl">
      <!-- Header Section -->
