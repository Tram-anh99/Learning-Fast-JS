        ...
        <form class="space-y-6" @submit.prevent>
          ...
          <div class="bg-[#E8F5E9]/30 p-4 rounded-lg space-y-4 border border-[#2E7D32]/10">
            ...
            <div>
              ...
              <label class="flex text-sm font-bold mb-2 items-center gap-1" style="color: #24504b;">
          ...
          <div class="pt-2 flex items-center gap-3">
            ...
            <!-- ========== CANCEL BUTTON ========== -->
            <!-- Cancel: flex-1 = take 1 part of flex space (equal to save button) -->
            <!-- border-[#D7CCC8] = sandy border, text-[#8D6E63] = brown text -->
            <!-- @click = emit cancel event to parent (close form without saving) -->
            <button @click="$emit('cancel')"
              class="flex-1 py-3 sm:py-3.5 px-4 sm:px-6 rounded-lg border border-[#D7CCC8] text-[#8D6E63] font-bold hover:bg-[#FAFAF5] transition-colors text-sm sm:text-base"
              type="button">
              Hủy
            </button>

            <!-- ========== SAVE BUTTON ========== -->
            <!-- Save: flex-1 = take 1 part of flex space (equal to cancel button) -->
            ...
            <button @click="$emit('save')"
              class="flex-1 py-3 sm:py-3.5 px-4 sm:px-6 rounded-lg bg-[#2E7D32] text-white font-bold shadow-lg shadow-[#2E7D32]/30 hover:bg-green-800 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
              type="button">
              <!-- Icon: save = Material Symbol for save action -->
              <span class="material-symbols-outlined text-lg sm:text-xl">save</span>
              <!-- Button text: "Lưu" = Save -->
              Lưu
            </button>
          </div>
        </form>
