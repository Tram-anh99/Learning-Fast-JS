...
<template>
      <div class="flex flex-col h-full">
            ...
            <div class="relative flex items-end h-40 bg-center bg-cover flex-shrink-0"
                  :style="{ backgroundImage: `url(${vung.anh})` }">
                  <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
                  <div class="relative z-10 w-full p-4 text-white">
                        <h2 class="text-xl font-bold text-shadow">{{ vung.ten }}</h2>
                        <span
                              class="inline-block px-3 py-1 mt-1 text-xs font-bold text-gray-800 bg-yellow-400 rounded-md">
            ...
            <!-- Scrollable content -->
            <div class="flex-grow p-5 space-y-5 overflow-y-auto pb-6">
