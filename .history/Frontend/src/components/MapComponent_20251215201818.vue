...
<template>
      ...
      <div class="flex-[2] relative rounded-xl overflow-hidden shadow-md border border-white">
            ...
            <div class="absolute top-5 right-5 z-50 bg-white p-2.5 rounded-lg shadow-lg flex flex-col gap-2 w-44">
                  ...
                  <!-- Button 1: Layer Hành chính (Bản đồ địa chính) -->
                  <!-- :class binding = áp dụng CSS class active khi cheDoXem === 'hanh_chinh' -->
                  <!-- @click="batCheDoHanhChinh" = gọi function khi click -->
                  ...
                  <!-- Button 2: Layer Sâu bệnh (Mật độ dịch bệnh) -->
                  <!-- Hiển thị heatmap dịch bệnh khi click -->
                  ...
                  <!-- Button 3: Layer Dư lượng thuốc (Phân tích hóa chất) -->
                  <!-- TODO: Chưa implement event handler -->
