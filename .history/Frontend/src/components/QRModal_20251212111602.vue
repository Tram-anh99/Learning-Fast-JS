      ...
      <div v-if="show" @click.self="$emit('close')"
            ...
            <div
                  ...
                  <div class="relative z-10 flex gap-2">
                        <button @click="$emit('close')"
                              class="flex-1 py-2 px-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all duration-200 active:scale-95 flex items-center justify-center gap-1 text-sm">
                              <span>✓ Xong</span>
                        </button>

                        <button @click="$emit('close')"
                              class="flex-1 py-2 px-3 text-gray-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-200 text-sm border border-gray-200">
                              Đóng
                        </button>
                  </div>
