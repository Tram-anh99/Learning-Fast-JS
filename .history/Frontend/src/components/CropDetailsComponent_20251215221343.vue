      ...
      <div v-if="props.selectedVung" class="flex gap-5">
                  ...
                  <div v-if="props.selectedVung.lichSuCanhTac && props.selectedVung.lichSuCanhTac.length > 0"
                        ...
                        <div v-for="(hoatDong, index) in props.selectedVung.lichSuCanhTac" :key="index"
                              ...
                              <div class="flex items-start gap-2">
                                    <div
                                          class="flex-shrink-0 bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs font-bold">
                                          {{ hoatDong.ngay }}
                                    </div>
                                    <div class="flex-1">
                                          <p class="text-sm font-semibold text-gray-800 mb-1">{{ hoatDong.hoatDong }}
                                          </p>
            ...
            <div class="w-64 bg-white rounded-xl shadow-md border border-white p-5">
                  ...
                  <div class="flex flex-col items-center gap-4">
                        <!-- QR Code Icon -->
                        <div class="w-48 h-48 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg flex items-center justify-center border-2 border-purple-200 shadow-inner">
                              <div class="text-center">
                                    <i class="fas fa-qrcode text-7xl text-purple-400 mb-3"></i>
                                    <p class="text-xs text-gray-500 font-semibold">Click để xem mã QR</p>
                              </div>
                        </div>
                        ...
                        <!-- Button mở modal QR -->
                        <button 
                              @click="emit('openQR', props.selectedVung.maQR || props.selectedVung.ma)"
                              class="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-sm font-semibold py-3 px-4 rounded-lg text-center transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
                        ...
                        <div class="bg-gray-50 p-3 rounded text-xs text-gray-600 w-full">
                              ...
                              <p>Click nút trên để xem và chia sẻ mã QR truy xuất nguồn gốc sản phẩm</p>
                        </div>
                  </div>
            </div>
