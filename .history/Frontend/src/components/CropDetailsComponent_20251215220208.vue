      ...
      <div v-if="props.selectedVung" class="flex gap-5">
            ...
            <div class="w-64 bg-white rounded-xl shadow-md border border-white p-5">
                  ...
                  <div class="flex flex-col items-center gap-3">
                        ...
                        <div
                              class="w-48 h-48 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg flex items-center justify-center border-2 border-gray-200 shadow-inner">
                        ...
                        <div class="text-center w-full">
                              ...
                              <p
                                    class="text-lg font-bold text-purple-600 bg-purple-50 py-2 px-4 rounded border border-purple-200">
