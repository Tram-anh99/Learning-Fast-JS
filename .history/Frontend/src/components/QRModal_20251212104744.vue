      ...
      <div v-if="show" @click.self="$emit('close')"
            ...
            <div class="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl p-6 text-center animate-scale-up">
                  ...
                  <button @click="$emit('close')"
                        class="absolute top-3 right-3 text-gray-400 hover:text-gray-600 transition-colors" title="Đóng">
                  ...
                  <div class="flex justify-center mb-6">
                        <div class="inline-block p-4 bg-white border-2 border-green-500 rounded-lg">
                              <QrcodeVue :value="qrValue" :size="220" level="H" render-as="svg" foreground="#15803d" />
                        </div>
                  </div>
