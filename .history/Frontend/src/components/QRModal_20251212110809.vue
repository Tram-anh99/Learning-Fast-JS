...
<template>
      ...
      <div v-if="show" @click.self="$emit('close')"
            ...
            <!-- Modal Card -->
            <div
                  class="relative w-full max-w-sm bg-gradient-to-br from-white via-slate-50 to-blue-50 rounded-3xl shadow-2xl p-8 text-center animate-scale-up border border-white/80 backdrop-blur-xl">

                  <!-- Decorative gradient circles (background) -->
                  <div
                        class="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-green-400/30 to-blue-400/30 rounded-full blur-3xl">
                  </div>
                  <div
                        class="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-br from-blue-400/30 to-purple-400/30 rounded-full blur-3xl">
                  </div>
                  ...
                  <div class="relative z-10 mb-8">
                        <div class="flex justify-center mb-4">
                              <div
                                    class="px-4 py-2 bg-gradient-to-r from-green-400 to-blue-400 rounded-full text-xs font-bold text-white shadow-lg">
                                    ✨ Chia sẻ nguồn gốc
                              </div>
                        </div>

                        <h3
                              class="text-3xl font-bold bg-gradient-to-r from-gray-900 via-green-700 to-blue-700 bg-clip-text text-transparent mb-2">
                              Mã QR Truy xuất
                        </h3>
