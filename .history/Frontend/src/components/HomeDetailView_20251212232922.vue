...
<template>
      <div class="flex flex-col h-full">
            ...
            <!-- Cover image header -->
            <div class="relative flex items-end h-32 bg-center bg-cover"
            ...
            <!-- Scrollable content -->
            <div class="flex-grow overflow-y-auto pb-32">
            ...
            <!-- Action buttons - Back button sticky -->
            <div class="flex-shrink-0 p-4 space-y-2 border-t border-gray-200 sticky bottom-0 bg-white">
