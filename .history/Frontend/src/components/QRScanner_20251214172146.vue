                  ...
                  <div class="w-full overflow-hidden bg-white shadow-xl sm:w-96 rounded-t-3xl sm:rounded-2xl"
                        ...
                        <div class="flex gap-3 p-6 border-t border-gray-200">
                              ...
                              <button v-if="!isScanning" @click="startCamera"
                                    class="flex items-center justify-center flex-1 gap-2 px-4 py-3 font-semibold text-gray-700 transition-colors border-2 border-gray-300 rounded-lg hover:border-gray-400">
                                    <!-- Icon camera -->
