...
<template>
      <li @click="$emit('select', item)"
            class="group bg-white/80 p-3 rounded-xl shadow-sm border border-gray-100 flex items-center gap-3 cursor-pointer transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98]">
            <!-- Ảnh đại diện -->
