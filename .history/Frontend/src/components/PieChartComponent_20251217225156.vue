...
<template>
      ...
      <div class="w-full h-full flex flex-col overflow-hidden">
            ...
            <div class="flex-shrink-0 mb-2 sm:mb-3">
                  <h3 class="text-sm sm:text-base font-bold text-gray-800">Phân bổ Thị trường</h3>
                  <p class="text-[10px] sm:text-xs text-gray-500">Giá trị xuất khẩu theo thị trường (USD)</p>
            </div>
