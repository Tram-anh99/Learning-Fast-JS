<template>
  ...
  <div class="absolute bottom-4 left-4 z-[9999] transition-all duration-300 ease-in-out"
    ...
    <div v-if="isExpanded"
      class="p-4 text-gray-800 border rounded-tl-none shadow-2xl bg-white/80 backdrop-blur-md rounded-xl border-white/50"
...
const barData = {
  labels: ['T1', 'T2', 'T3'],
  datasets: [
    { label: 'Hóa học', backgroundColor: '#2563eb', data: [22, 18, 23], borderRadius: 2 },
    { label: 'Sinh học', backgroundColor: '#0d9488', data: [9, 14, 12], borderRadius: 2 }
  ]
}
...
// Cấu hình ẩn trục để widget gọn
