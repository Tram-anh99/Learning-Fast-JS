...
<template>
  <div class="flex flex-col h-full">
    ...
    <!-- Cover image header -->
    <div 
      class="h-44 bg-cover bg-center relative flex items-end"
    ...
    >
      ...
      <div class="relative z-10 w-full p-4 text-white">
        ...
        <span class="inline-block mt-2 px-3 py-1 bg-yellow-400 text-gray-800 rounded-md text-xs font-bold">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 inline mr-1" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div>
        <h4 class="font-bold text-gray-800 text-sm mb-3 pb-2 border-b-2 border-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 inline mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 000-2H6V3a1 1 0 01-1 1V2zM3 5a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm0 2h14v8H3V7z" clip-rule="evenodd" />
          </svg>
          Nhật ký Canh tác
        </h4>
        ...
        <div class="space-y-3 border-l-2 border-gray-300 pl-4 ml-2">
          <div v-for="(log, idx) in vung.nhatKy" :key="idx" class="relative">
            <!-- Dot -->
            <div class="absolute w-3 h-3 bg-green-500 rounded-full -left-5 top-1.5 border-2 border-white"></div>
    ...
    <div class="border-t border-gray-200 p-4 space-y-2 flex-shrink-0">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm0 6a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zm10-9a2 2 0 110 4 2 2 0 010-4zM2 15a1 1 0 101 2h1a1 1 0 100-2H3z" />
        </svg>
        Mã QR Truy xuất
      </button>
      <button 
