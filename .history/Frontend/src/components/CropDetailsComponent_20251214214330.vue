      ...
      <div v-if="selectedVung" class="panel flex flex-col min-h-[350px] max-h-[600px] overflow-auto">
            ...
            <div class="panel-header">
                  ...
                  <div class="text-right text-xs">
                        <p class="font-semibold text-gray-600">Tổng diện tích: <span class="text-blue-600">{{ totalAreaInZone.toFixed(1) }} ha</span></p>
                        <p class="font-semibold text-gray-600 mt-1">Giá trị xuất khẩu: <span class="text-green-600">${{ Math.round(totalExportValue).toLocaleString() }}</span></p>
                  </div>
            </div>
                  ...
                  <table class="w-full border-collapse">
                        ...
                        <tbody>
                              <tr v-for="crop in cropsInZone" :key="crop.id" class="table-row-hover">
                                    ...
                                    <td class="table-cell text-center text-green-600 font-semibold">${{ crop.giaXuat }}</td>
                                    <td class="table-cell text-center font-semibold text-blue-600">${{ Math.round(crop.dienTich * crop.nangSuat * crop.giaXuat).toLocaleString() }}</td>
                                    <td class="table-cell">
