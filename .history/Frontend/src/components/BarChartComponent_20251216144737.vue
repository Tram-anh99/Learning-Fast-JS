...
<template>
      ...
      <div class="w-full h-full flex flex-col">
            <!-- Tiêu đề -->
            <h3 class="text-base font-bold text-gray-800 mb-3">Năng suất Cây trồng (tạ/ha)</h3>
            ...
            <!-- Stats footer -->
            <div class="text-sm text-center text-gray-600 pt-3 border-t border-gray-200 mt-3">
