          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input :value="formData.datetime"
                ...
                class="block w-full h-14 rounded-lg border border-[#D7CCC8] bg-[#FAFAF5]/50 px-4 text-gray-900 focus:border-[#2E7D32] focus:ring-2 focus:ring-[#2E7D32] text-base shadow-sm transition-colors cursor-pointer font-medium"
                type="datetime-local" />
            </div>
          </div>
