...
export const mockDataVung = [
     ...
     },
     {
          ...
          lichSuCanhTac: [
               { ngay: "2024-12-12", hoatDong: "Mã bị thu hồi do vi phạm quy trình", nguoiThucHien: "Chi cục NN" },
               { ngay: "2024-12-01", hoatDong: "Sử dụng thuốc bảo vệ thực vật cấm", nguoiThucHien: "Võ Văn D" },
               { ngay: "2024-11-20", hoatDong: "Bón phân", nguoiThucHien: "Võ Văn D" },
          ],
          maQR: "VT-005",
     },
];
