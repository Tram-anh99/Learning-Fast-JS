...
export const mockCropDetails = [
     ...
     // Bổ sung các loại cây khác để biểu đồ đa dạng hơn
     // VT-001: Bổ sung cây Dừa
     {
          id: 11,
          maVung: "VT-001",
          tenCay: "Dừa",
          ...
          namTrau: 2020,
          nangSuat: 38.5,
          thiBruongXuatKhau: ["ASEAN", "Trung Quốc"],
          giaXuat: 0.75,
     },

     // VT-002: Bổ sung Cà phê
     {
          id: 12,
          maVung: "VT-002",
          ...
          namTrau: 2019,
          nangSuat: 45.2,
          thiBruongXuatKhau: ["Châu Âu", "Hoa Kỳ", "Nhật Bản"],
          giaXuat: 2.2,
     },
     {
          id: 13,
          ...
          namTrau: 2020,
          nangSuat: 40.8,
          thiBruongXuatKhau: ["Châu Âu", "Nhật Bản"],
          giaXuat: 2.8,
     },

     // VT-003: Bổ sung Rau củ
     {
          id: 14,
          maVung: "VT-003",
          tenCay: "Rau an toàn",
          ...
          namTrau: 2023,
          nangSuat: 65.0,
          thiBruongXuatKhau: ["Nội địa", "ASEAN"],
          giaXuat: 0.35,
     },
     ...
     // VT-005: Bổ sung Chanh dây
     {
          ...
          namTrau: 2022,
          nangSuat: 42.0,
          thiBruongXuatKhau: ["Châu Âu", "Nhật Bản", "Hoa Kỳ"],
          giaXuat: 1.5,
     },
];
