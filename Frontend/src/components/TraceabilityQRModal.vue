      ...
      <div v-if="show"
            ...
            <div class="relative w-full max-w-sm p-6 text-center bg-white shadow-2xl rounded-2xl animate-scale-up">
                  ...
                  <button @click="handleClose"
                        class="absolute text-gray-400 top-3 right-3 hover:text-gray-600 transition-colors" title="Đóng">
                  ...
                  <div class="flex justify-center mb-4">
                        <div class="inline-block p-3 border-2 border-green-500 rounded-xl">
                              <qrcode-vue :value="qrValue" :size="200" level="H" render-as="svg" foreground="#15803d" />
                        </div>
                  </div>
